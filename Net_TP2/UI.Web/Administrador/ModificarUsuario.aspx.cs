...
namespace UI.Web.Administrador
{
    public partial class ModificarUsuario : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.txtLegajo.Text = UsuarioActual.Legajo.ToString();
            this.txtTelefono.Text = UsuarioActual.Telefono.ToString();
            this.ddlsTipoPersona.Text =(this.UsuarioActual.TipoPersona).ToString();
            this.ddlPlan.Text = new PlanLogic().GetOne(UsuarioActual.IDPlan).Descripcion;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            usr.setTipoPersona(this.ddlsTipoPersona.Text);
